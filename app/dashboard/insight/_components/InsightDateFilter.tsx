    ...
    <div className="relative" onClick={(event) => event.stopPropagation()}>
      ...
      {showDateDropdown && (
        <>
          ...
          {/* Dropdown — di mobile pakai fixed + centered, di desktop absolute */}
          <div
            className="
            fixed left-1/2 top-1/2 z-[999] w-[calc(100vw-2rem)] max-w-xs -translate-x-1/2 -translate-y-1/2
            overflow-hidden rounded-2xl border border-[#E2E8F0] bg-white shadow-xl
            md:absolute md:left-auto md:right-0 md:top-full md:mt-2 md:w-64
