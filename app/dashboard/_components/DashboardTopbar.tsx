...
export default function DashboardTopbar({
  ...
  return (
    <header className="fixed top-0 z-50 mx-auto flex w-full max-w-full items-center justify-between border-b border-[#E2E8F0] bg-white/80 px-8 py-4 font-['Plus_Jakarta_Sans'] text-sm tracking-tight text-[#2563EB] shadow-sm backdrop-blur-md md:w-[calc(100%-16rem)]">
      <div className="flex items-center gap-4">
        <div className="text-xl font-bold tracking-tighter text-[#2563EB] md:hidden">
          Receipt Manager
        </div>
      </div>
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          <img
            ...
            className="ml-2 h-9 w-9 cursor-pointer rounded-full border-2 border-[#E2E8F0] shadow-sm"
